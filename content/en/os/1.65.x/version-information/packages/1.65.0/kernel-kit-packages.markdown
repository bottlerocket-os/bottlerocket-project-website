---
title: "Kernel Kit packages 9.1.0"
type: "docs"
description: "Kernel Kit Package Versions in Bottlerocket Release 1.65.0"
packages:
  - package: grub
    version: 2.06
    patches:
  ...
  - package: kernel-6.12
    version: 6.12.103
    patches:
      - "1008-Revert-selinux-fix-overlayfs-mmap-and-mprotect-acces.patch"
      - "1001-Makefile-add-prepare-target-for-external-modules.patch"
  ...
  - package: kernel-6.18
    ...
    patches:
      ...
      - "1002-Revert-kbuild-hide-tools-build-targets-from-external.patch"
      - "1003-initramfs-unlink-INITRAMFS_FORCE-from-CMDLINE_-EXTEN.patch"
      - "1006-Revert-selinux-fix-overlayfs-mmap-and-mprotect-acces.patch"
      - "1004-af_unix-increase-default-max_dgram_qlen-to-512.patch"
