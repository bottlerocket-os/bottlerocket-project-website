---
title: "Kernel Kit packages 5.0.1"
type: "docs"
description: "Kernel Kit Package Versions in Bottlerocket Release 1.56.0"
packages:
  - package: grub
    version: 2.06
    patches:
  ...
  - package: kernel-6.1
    ...
    patches:
      ...
      - "0001-Revert-wireguard-device-enable-threaded-NAPI.patch"
