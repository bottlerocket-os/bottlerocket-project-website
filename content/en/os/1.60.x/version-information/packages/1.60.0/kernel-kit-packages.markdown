---
title: "Kernel Kit packages 5.4.1"
type: "docs"
description: "Kernel Kit Package Versions in Bottlerocket Release 1.60.0"
packages:
  - package: grub
    version: 2.06
    patches:
      ...
      - "0048-Hard-code-BOOT_IMAGE-on-kernel-command-line.patch"
  ...
  - package: kernel-6.1
    version: 6.1.166
    patches:
      - "1010-crypto-algif_aead-Revert-to-operating-out-of-place.patch"
      - "1013-crypto-authencesn-Do-not-place-hiseq-at-end-of-dst.patch"
      - "1009-crypto-algif_aead-use-memcpy_sglist-instead-of-null-skcipher.patch"
      - "1012-crypto-authenc-use-memcpy_sglist-instead-of-null-skcipher.patch"
      ...
      - "1008-crypto-scatterwalk-Backport-memcpy_sglist.patch"
      - "1016-crypto-algif_aead-Fix-minimum-RX-size-check-for-decryption.patch"
      - "1004-af_unix-increase-default-max_dgram_qlen-to-512.patch"
      - "1003-initramfs-unlink-INITRAMFS_FORCE-from-CMDLINE_-EXTEN.patch"
      - "1015-crypto-af_alg-Fix-page-reassignment-overflow-in-af_alg_pull_tsgl.patch"
      ...
      - "1011-crypto-algif_aead-snapshot-IV-for-async-AEAD-requests.patch"
      - "1014-crypto-authencesn-Fix-src-offset-when-decrypting-in-place.patch"
      - "1006-strscpy-write-destination-buffer-only-once.patch"
  - package: kernel-6.12
    version: 6.12.79
    patches:
      - "1001-Makefile-add-prepare-target-for-external-modules.patch"
      - "1014-crypto-authencesn-Do-not-place-hiseq-at-end-of-dst.patch"
      - "1002-Revert-kbuild-hide-tools-build-targets-from-external.patch"
      - "1015-crypto-authencesn-Fix-src-offset-when-decrypting-in-place.patch"
      - "1007-strscpy-write-destination-buffer-only-once.patch"
      - "1004-af_unix-increase-default-max_dgram_qlen-to-512.patch"
      - "1005-Lustre-cast-unsigned-long-to-pointer.patch"
      - "1009-crypto-scatterwalk-Backport-memcpy_sglist.patch"
      - "1011-crypto-algif_aead-Revert-to-operating-out-of-place.patch"
      - "1016-crypto-af_alg-Fix-page-reassignment-overflow-in-af_alg_pull_tsgl.patch"
      - "1017-crypto-algif_aead-Fix-minimum-RX-size-check-for-decryption.patch"
      - "1013-crypto-authenc-use-memcpy_sglist-instead-of-null-skcipher.patch"
      - "1003-initramfs-unlink-INITRAMFS_FORCE-from-CMDLINE_-EXTEN.patch"
      - "1012-crypto-algif_aead-snapshot-IV-for-async-AEAD-requests.patch"
      - "1010-crypto-algif_aead-use-memcpy_sglist-instead-of-null-skcipher.patch"
  ...
  - package: kernel-6.18
    ...
    patches:
      - "1001-Makefile-add-prepare-target-for-external-modules.patch"
      - "1005-drm-simpledrm-Select-prerequisites-for-gpu-drivers.patch"
      - "1007-crypto-af-alg-fix-NULL-pointer-dereference-in-scatterwalk.patch"
      - "1002-Revert-kbuild-hide-tools-build-targets-from-external.patch"
      - "1004-af_unix-increase-default-max_dgram_qlen-to-512.patch"
      - "1011-crypto-af_alg-limit-RX-SG-extraction-by-receive-buffer-budget.patch"
      - "1008-crypto-algif_aead-Revert-to-operating-out-of-place.patch"
      - "1009-crypto-algif_aead-snapshot-IV-for-async-AEAD-requests.patch"
      - "1003-initramfs-unlink-INITRAMFS_FORCE-from-CMDLINE_-EXTEN.patch"
      - "1010-crypto-authencesn-Do-not-place-hiseq-at-end-of-dst.patch"
      - "1013-crypto-algif_aead-Fix-minimum-RX-size-check-for-decryption.patch"
      - "1006-efi-libstub-don-t-measure-kernel-command-line-into-P.patch"
      - "1012-crypto-af_alg-Fix-page-reassignment-overflow-in-af_alg_pull_tsgl.patch"
      - "1014-crypto-authencesn-Fix-src-offset-when-decrypting-in-place.patch"
  - package: kmod-6.1-efa
    version: 3.0.0
  - package: kmod-6.1-nvidia-r580
    version: 580.126.09
    patches:
      - "0001-makefile-allow-to-use-any-kernel-arch.patch"
  - package: kmod-6.12-amdgpu
    version: 30.20.1
  - package: kmod-6.12-efa
    version: 3.0.0
  - package: kmod-6.12-nvidia-r580
    version: 580.126.09
    patches:
      - "0001-makefile-allow-to-use-any-kernel-arch.patch"
  - package: kmod-6.18-efa
    version: 3.0.0
  - package: kmod-6.18-nvidia-r580
    version: 580.126.09
    patches:
      - "0001-makefile-allow-to-use-any-kernel-arch.patch"
  - package: libkcapi
