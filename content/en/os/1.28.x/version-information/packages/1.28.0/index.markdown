...
title: "1.28.0"
type: "docs"
description: "Package Versions in Bottlerocket Release 1.28.0"
packages:
  ...
  - package: kernel-5.15
    ...
    patches:
      ...
      - "1100-netfilter-xtables-fix-typo-causing-some-targets-not-.patch"
  - package: kernel-6.1
    version: 6.1.115
    patches:
      - "1001-Makefile-add-prepare-target-for-external-modules.patch"
      ...
      - "1100-io_uring-always-lock-__io_cqring_overflow_flush.patch"
  - package: kexec-tools
    version: 2.0.29
  - package: keyutils
    version: 1.6.1
