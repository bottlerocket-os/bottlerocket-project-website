---
title: "Kernel Kit packages 7.0.1"
type: "docs"
description: "Kernel Kit Package Versions in Bottlerocket Release 1.63.0"
packages:
  - package: grub
    version: 2.06
    patches:
  ...
  - package: kernel-6.12
    ...
    patches:
      ...
      - "1009-Revert-selinux-fix-overlayfs-mmap-and-mprotect-acces.patch"
      - "1003-initramfs-unlink-INITRAMFS_FORCE-from-CMDLINE_-EXTEN.patch"
  ...
  - package: kernel-6.18
    version: 6.18.36
    patches:
      - "2001-Rename-struct-mempool-to-struct-neuron_mempool.patch"
      - "1001-Makefile-add-prepare-target-for-external-modules.patch"
      - "1005-drm-simpledrm-Select-prerequisites-for-gpu-drivers.patch"
      - "1002-Revert-kbuild-hide-tools-build-targets-from-external.patch"
      - "1007-Revert-selinux-fix-overlayfs-mmap-and-mprotect-acces.patch"
      - "1004-af_unix-increase-default-max_dgram_qlen-to-512.patch"
      - "1003-initramfs-unlink-INITRAMFS_FORCE-from-CMDLINE_-EXTEN.patch"
