---
title: "Core Kit packages 14.4.0"
type: "docs"
description: "Core Kit Package Versions in Bottlerocket Release 1.62.0"
packages:
  ...
  - package: containerd-2.1
    version: 2.1.7
    patches:
      - "1004-sandbox-forward-Create-fields-fix-event-topics.patch"
