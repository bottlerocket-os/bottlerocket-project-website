---
title: "Core Kit packages 14.5.1"
type: "docs"
description: "Core Kit Package Versions in Bottlerocket Release 1.62.1"
packages:
  ...
  - package: containerd-1.7
    version: 1.7.31
    patches:
      - "0001-Do-not-propagate-reserved-labels-from-image-configs.patch"
      ...
      - "0002-Bound-user-database-file-reads-in-openBoundedUserFil.patch"
  - package: containerd-2.1
    version: 2.1.8
    patches:
      - "0003-cri-do-not-re-tag-restored-checkpoints.patch"
      - "1003-ctr-default-hosts-dir-to-etc-containerd-certs.d.patch"
      - "0005-cri-make-checkpoint-restore-robust-to-unexpected-arc.patch"
      ...
      - "0004-Do-not-propagate-reserved-labels-from-image-configs.patch"
      - "0002-Bound-user-database-file-reads-in-openBoundedUserFil.patch"
      - "0001-cri-filter-CDI-annotations-on-checkpoint-restore.patch"
  - package: containerd-2.2
    version: 2.2.4
    patches:
      - "0002-Bound-user-database-file-reads-in-openUserFile.patch"
      - "0003-cri-do-not-re-tag-restored-checkpoints.patch"
      - "1003-ctr-default-hosts-dir-to-etc-containerd-certs.d.patch"
      - "0005-cri-make-checkpoint-restore-robust-to-unexpected-arc.patch"
      - "1002-transfer-service-fallback-to-credentials.toml-for-re.patch"
