---
title: "Core Kit packages 15.0.0"
type: "docs"
description: "Core Kit Package Versions in Bottlerocket Release 1.64.0"
packages:
  ...
  - package: kubernetes-1.36
    version: 1.36.1
    patches:
      - "0001-kubelet-startPodSync-reuse-the-previous-context-to-f.patch"
  - package: libacl
    version: 2.3.2
  - package: libaio
    version: 0.3.113
