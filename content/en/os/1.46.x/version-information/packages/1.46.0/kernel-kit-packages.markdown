---
title: "Kernel Kit packages 4.2.0"
type: "docs"
description: "Kernel Kit Package Versions in Bottlerocket Release 1.46.0"
packages:
  - package: grub
    version: 2.06
    patches:
  ...
  - package: kernel-6.1
    ...
    patches:
      ...
      - "1007-smb-client-Avoid-race-in-open_cached_dir-with-lease-.patch"
